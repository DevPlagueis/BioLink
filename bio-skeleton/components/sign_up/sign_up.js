...
function makeSignUp() {
    ...
    submit_btn.addEventListener('click', (e) => {
        ...
        // console.log(`${fname_input.value} ${lname_input.value} ${email_input.value} ${password_input.value}`)
        new_signup_request_user = {}
        new_signup_request_user.fname = fname_input
        new_signup_request_user.lname = lname_input
        new_signup_request_user.email = email_input
        new_signup_request_user.password = password_input
